...
const InterviewDetailsForm: React.FC<{
  ...
  getInterviewSettings: (key: string, values: any) => void;
}> = ({ handleTab,getInterviewSettings }) => {
  const {
    errors,
    touched,
    handleSubmit,
      ...
      <Box width="100%">
        <FormSelect
          ...
          onChange={(name: string, v: string) => {
            getInterviewSettings("interviewMode", v);
        ...
        <FormSelect
          ...
          onChange={(name: string, v: string) => {
            getInterviewSettings("interviewDuration", v);
            setFieldValue(name, v, true);
          }}
          onBlur={setFieldTouched}
        ...
        <FormSelect
          ...
          onChange={(name: string, v: string) => {
            getInterviewSettings("interviewLanguage", v);
            setFieldValue(name, v, true);
          }}
          onBlur={setFieldTouched}
